...
Our security policy is located [here](https://github.com/ministryofjustice/hmpps-court-appearance-scheduler-ui/security/policy).
...
`git remote add template https://github.com/ministryofjustice/hmpps-court-appearance-scheduler-ui`
